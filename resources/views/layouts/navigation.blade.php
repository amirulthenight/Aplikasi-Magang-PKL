<header x-data="{ mobileMenuOpen: false, sidebarOpen: false }" class="relative flex-shrink-0 flex h-16 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-sm border-b border-gray-200 dark:border-gray-700/50 z-30">
    ...
    <button @click.stop="$dispatch('toggle-sidebar')" class="px-4 border-r border-gray-200 dark:border-gray-700/50 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:hidden">
    ...
    <div :class="{'block': mobileMenuOpen, 'hidden': ! mobileMenuOpen}" class="hidden sm:hidden border-t border-gray-200 dark:border-gray-700">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('laporan.index')" :active="request()->routeIs('laporan.*')">
                <x-slot name="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h12M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0l-3.75 3.75M3.75 21v-6.125A2.25 2.25 0 006 12.75h12M15 7.5h3.75m-3.75 0-3.75 3.75M3.75 12h16.5" />
                    </svg>
                </x-slot>
                {{ __('Laporan') }}
            </x-responsive-nav-link>
